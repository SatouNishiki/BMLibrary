...
namespace BMErrorLibrary
{
    ...
    public class BMError
    {
        ...
        /// <summary>
        /// 引数で受け取ったエラーメッセージをログファイルに出力し、メッセージボックスを表示する
        /// </summary>
        /// <param name="errorMessage"></param>
        public static void ErrorMessageOutput(string errorMessage)
        {
        ...
        /// </summary>
        /// <param name="errorMessage"></param>
        public static void ErrorMessageOutputNothingMessage(string errorMessage)
        {
            //エラーログ用のディレクトリが存在していなかったら作る
            if (!System.IO.Directory.Exists(errorDirectory))
            {
